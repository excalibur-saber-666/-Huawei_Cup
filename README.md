...
- paper_notes/：145 张可追溯经验卡；其中 12 张已完成本轮 `partial` 精读，其余待逐篇深度审阅。
- question_notes/：同题多篇论文横向比较；当前有 2024 A—C 三张完整同题横向卡，另有 3 张基于已核对单篇案例的基础卡。
...
| 逐篇深度语义审阅 | 0 complete / 12 partial / 133 pending；已通读 2024 A、B、C 各 4 篇正文并抽查关键 PDF |
