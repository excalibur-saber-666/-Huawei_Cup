...
- paper_notes/：145 张可追溯经验卡；其中 29 张已完成本轮 `partial` 精读，其余待审阅。当前后续口径为每题精读 1 篇代表论文，其余只做概览且不计入 partial。
- question_notes/：同题论文比较；当前有 2024 A—C 三张完整同题横向卡，以及 2022 A—B、2023 A—F、2024 D—F、2025 A—F 共 17 张代表性精读题级卡。2022 A—B 与 2023—2025 每个赛题均至少精读 1 篇代表论文。
...
| 逐篇深度语义审阅 | 0 complete / 29 partial / 116 pending；已通读 2022 A—B、2023 A—F、2024 D—F、2025 A—F 代表论文各 1 篇，2024 A、B、C 各 4 篇，并抽查关键 PDF |
